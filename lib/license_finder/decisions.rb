  ...
  class Decisions
    ...
    def self.restore(persisted, result = new)
      ...
      if (list_of_actions & %i{whitelist blacklist}).any?
        raise 'The dependency_decisions.yml seems to have whitelist/blacklist keys which are deprecated. Please replace them with permit/restrict respectively and try again! More info - https://github.com/pivotal/LicenseFinder/commit/a40b22fda11b3a0efbb3c0a021381534bc998dd9'
      end
